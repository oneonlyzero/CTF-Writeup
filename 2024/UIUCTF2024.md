...
* This one quite easy to solve :). The challenge has mentioned 2 things that we can take to start the searching which is `The Long Island Subwway Authority (LISA)` and `Instagram`, Jump to  `Instagram` and find profile that related to the `LISA`. And you will find this account:
